...
INNER JOIN TITLE T 
ON W.WORKER_ID = T.WORKER_REF_ID
WHERE T.WORKER_TITLE = 'Manager' AND B.BONUS_AMOUNT = 5000;
...
SELECT W.FIRST_NAME, W.SALARY, B.BONUS_AMOUNT
FROM WORKER W 
RIGHT JOIN BONUS B
ON W.WORKER_ID = B.WORKER_REF_ID;
...
SELECT W.WORKER_ID, W.FIRST_NAME, W.DEPARTMENT, 
B.BONUS_AMOUNT, B.BONUS_DATE
FROM Worker W
...
B.BONUS_AMOUNT, B.BONUS_DATE
FROM Worker W
RIGHT JOIN Bonus B ON W.WORKER_ID = B.WORKER_REF_ID;
