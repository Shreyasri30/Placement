...
INSERT INTO Worker 
	(WORKER_ID, FIRST_NAME, LAST_NAME, SALARY, JOINING_DATE, DEPARTMENT) VALUES
        ...
        SELECT FIRST_NAME, MIN(SALARY) FROM WORKER GROUP BY FIRST_NAME HAVING MIN(SALARY) > 50000;
        SELECT WORKER_ID, MAX(JOINING_DATE) FROM WORKER GROUP BY WORKER_ID HAVING MAX(JOINING_DATE) > '2014-06-11';
